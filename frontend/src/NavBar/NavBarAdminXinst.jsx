/**<div className=""></div>* @fileoverview Este archivo contiene el componente NavBar-Guest, el objeto que será la barra de navegación para los invitados
...
import backButton from '../../../íconos/botonAtras.png'; // Icono de flecha usado en botones.
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-custom fixed-top">
            ...
            <div className="container-fluid">
                {/* Área delbotón regresar en la barra de navegación, actúa como enlace a la página de inicio. */}
                <a className="navbar-brand" href="#">

                    <img src={backButton} alt="backButton" className="backButton" height={40} />
                </a>
                ...
                <div className={`dropdown-menu${isDropdownOpen ? ' show' : ''} shadow-lg`} aria-expanded={isDropdownOpen}>
                    ...
                    <li>
                        <Link to="/Login" className="dropdown-item">Ver instituciones</Link>
                    </li>
                    <li>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link to="/Login" className="btn btn">
                                <a className="nav-link active" aria-current="page">Estadisticas</a>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/Login" className="btn btn">
