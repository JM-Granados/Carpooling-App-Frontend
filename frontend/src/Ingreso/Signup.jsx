    ...
    return (
        <div className="subfondoSignup text-start align-center mx-5">
            ...
            <div className="CampoMensajeRe">
                <h1 className="MensajeRe fw-light mt-3">Por favor introduce tus datos para registrate. Recuerda que debes fromar parte de una institución válida para poder registrarte exitosamente.</h1>
            </div>
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div class="d-grid gap-2 col-6 mx-auto mt-5">
                    <button class="BotonIniciarSesion btn btn-primary border border-0 fw-bold" type="button">Registrarse</button>
                    <div className="form-text text-start mt-2 d-flex mb-5" id="basic-addon4">
                        ...
                        <div className="Reg text-center mb-4" style={{ flexGrow: 0.78 }}>
                            <Link to="/Login" className="Reg d-flex justify-content-center">Iniciar sesión</Link>
                        </div>
                    </div>
                </div>
